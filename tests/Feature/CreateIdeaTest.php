...
class CreateIdeaTest extends TestCase {
    ...
    public function create_idea_form_does_not_show_when_logged_out() {
        ...
        $response->assertDontSee("Let us know what you would like to do and we'll take a look");
    }
    ...
    public function create_idea_form_does_show_when_logged_in() {
        ...
        $response->assertSee("Let us know what you would like to do and we'll take a look", false);
    }

    /** @test */
    public function main_page_contains_create_idea_livewire_comppnent() {
    ...
    public function creating_an_idea_works_correctly() {
        ...
        Livewire::actingAs($user)
            ...
            ->set('description', 'My description for my first idea')
            ->call('createIdea')
            ->assertRedirect('/');
        ...
        $response->assertSee('My description for my first idea');
