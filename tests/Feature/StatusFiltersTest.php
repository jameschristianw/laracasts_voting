...
class StatusFiltersTest extends TestCase {
    ...
    /** @test */
    public function index_page_containts_status_filters_livewire_component() {
    ...
    /** @test */
    public function show_page_containts_status_filters_livewire_component() {
        $user = User::factory()->create();
    ...
    public function shows_correct_status_count() {
        ...
        Livewire::test(StatusFilters::class)
            ->assertSee("All Ideas (2)", false)
            ->assertSee('Implemented (2)', false);
    }
    ...
    public function filtering_works_when_query_string_in_place() {
        ...
        $statusImplemented = Status::factory()->create(['name' => "Im", 'classes' => 'bg-blue text-white']);
